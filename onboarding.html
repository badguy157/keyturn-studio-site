...
<header class="container">
  <nav class="nav" aria-label="Primary">
    ...
    <div class="nav-links">
      ...
      <a class="cta" href="/audit.html">Get a 10-min audit</a>
    </div>
  </nav>
  ...
  <section class="container section">
    <div class="grid">
      ...
      <article class="card">
        ...
        <p class="tiny">Guarantees &amp; cancellation terms are listed on the homepage.</p>
      </article>
      ...
      <article class="card">
        ...
        <p class="tiny">Pre-launch website-direct baseline currently: <strong>7.65%</strong>. Post-launch seasonal projection mid-case: <strong>~21.7%</strong>.</p>
      </article>
    </div>
  </section>
  ...
  <section class="container section">
    <div class="grid">
      <article class="card">
        ...
        <p class="tiny">Work starts after first payment. You own domain, content, images, and code.</p>
      </article>
    ...
    <div class="buttons" style="margin-top:12px">
      <a class="btn primary" href="/audit.html">Request your audit</a>
      <a class="btn" href="/#results">See results</a>
    </div>
  </section>
</main>
...
<!-- Sticky mobile CTA -->
<a href="/audit.html#audit" class="sticky-cta" aria-label="Request an audit">Request audit</a>
